            ...
            <div class="col-lg-6 col-12 text-black d-flex justify-content-center align-items-center">
                <div class="">
                    <div class="d-flex align-items-center">
                        ...
                        <form style="width: 28rem; height: auto;" action="{{ route('daftar') }}" method="post">
                            @csrf
                            ...
                            <div class="pt-3 px-4 mb-4 d-flex justify-content-center">
                                <button data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-lg btn-block" type="submit">Register</button>
                            </div>

                            <p class="text-center">Have account already? <a href="{{ route('login') }}" class="link-info">Just Login</a></p>
