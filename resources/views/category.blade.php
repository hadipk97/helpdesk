    ...
    <section class="content">
        <div class="card">
            <div class="card-body">
                ...
                <h3 class="card-title">Categories in Info Centre</h3>
                <br>
    ...
    <div id="edit-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="edit-form" action="{{ route('service_update') }}" method="post" class="pl-3 pr-3">
                        @csrf
                        <div class="row">
                            <input type="hidden" id="service-id" name="id" class="form-control" placeholder="Id"
